// Dados de Sensibilidade dos Famosos
const sensiData = {
  "Nobru": {
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderPage(page) {
    window.scrollTo(0, 0);
    switch(page) {
      case 'sensi-famosos': renderSensiFamosos(); break;
      case 'gerar-sensi': renderSensiAleatoria(); break;
      case 'sensi-arma': renderSensiArma(); break;
      case 'dpi-android': renderDPI(); break;
      case 'ciclos-iphone': renderCiclos(); break;
  ...
  function renderSensiFamosos() {
    contentArea.innerHTML = `
      ...
      <div class="input-group">
        ...
        <input type="text" id="famoso-input" class="input-field" placeholder="Digite o nome do pro player...">
  ...
  function renderSensiArma() {
    contentArea.innerHTML = `
      ...
      <div class="input-group">
        ...
        <input type="text" id="arma-input" class="input-field" placeholder="Digite o nome da arma...">
        <div class="suggestions">
  ...
  function renderDPI() {
    contentArea.innerHTML = `
      ...
      <div class="warning-banner">
        <span>⚠️</span>
        <span>DPI é ajuste do sistema e costuma existir apenas no Android. Use com cuidado.</span>
      </div>
  ...
  function renderFavoritos() {
    contentArea.innerHTML = `
      ...
      <div class="empty-state">
        ...
        <button class="main-action-btn" style="margin-top: 20px;" id="btn-voltar-home">Voltar para Home</button>
      </div>
    `;
    document.getElementById('btn-voltar-home').onclick = () => renderPage('home');
  ...
  function setupPageEvents(type) {
    ...
    document.querySelectorAll('.chip, .style-btn').forEach(btn => {
      btn.onclick = function() {
        ...
        if (this.classList.contains('chip') && input) {
      ...
      <div class="result-card">
        ...
        <div class="dpi-display">
          <div class="dpi-main">
            ...
            <div class="dpi-big-val">${data.Principal}</div>
          </div>
